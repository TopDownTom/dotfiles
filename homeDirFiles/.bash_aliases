...
$a copyImage='xclip -selection c -t image/png'
...
$a pp='python3 /usr/local/src/posting_procedure/develop/createDoc.py'
$a py3='`which python3`'
...
$a gm='cd $HOME/music'
$a gp='cd $HOME/pix'
$a gpp='cd /usr/local/src/posting_procedure/develop'
$a gr='cd $REPOS/'
$a gs='cd $SCRIPT_DIR'
